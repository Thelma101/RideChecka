// Realistic Nigerian ride-hailing fare models (2024-2025)
// Sources: publicly advertised rates, user reports, industry analyses
//
...
export const FARE_MODELS: FareModel[] = [
  {
    ...
    vehicleTypes: [
      ...
      { type: 'Uber Comfort', multiplier: 1.35 },
